...
//!
//! `FileId`, `SymbolId`, and `SnapshotId` are newtyped `u32` values
//! generated by `IdGenerator<T>` which wraps an `AtomicU32` for
//! lock-free allocation across rayon worker threads.
